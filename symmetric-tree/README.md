<h2>101. Symmetric Tree</h2><h3>Easy</h3><hr><div style="user-select: auto;"><p style="user-select: auto;">Given the <code style="user-select: auto;">root</code> of a binary tree, <em style="user-select: auto;">check whether it is a mirror of itself</em> (i.e., symmetric around its center).</p>
